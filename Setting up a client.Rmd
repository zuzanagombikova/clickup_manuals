...
**Client profile = task in ClickUp.**
...
Keep in mind the task will house the client’s profile & the actions on it before the client is moved to ListenLocal/Data Observatory/Other project.
  ...
  1. Open the Calendar view (you can start from any other view, Calendar is just the most visual one when scheduling an interview)
  
  ![](/Users/Susana/Documents/dani_reka_collaboration/clickup/Manuals/pics/Setting up a client_1.png)
  
  
  2. Create a new task = client profile.
  
  ![](/Users/Susana/Documents/dani_reka_collaboration/clickup/Manuals/pics/Setting up a client_2.png)
  
  3. Click it open & Edit the task
  
      ![](/Users/Susana/Documents/dani_reka_collaboration/clickup/Manuals/pics/Setting up a client_3.png)
1. Status – to be changed based on the current situation. Start status is **1st interview to be scheduled**.
...
9. Fields – fill in as per below, fill in as much as you know
...
*Congratulations!* You have now created a client’s profile and can schedule the first interview!
